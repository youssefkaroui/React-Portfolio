...
function AboutMe() {
    ...
    return(
        <section className="container">
            ...
            <hr></hr>
            <div>
                <img className="mb-5" id="avatar" src="https://avatars.githubusercontent.com/u/99456321?u=c75855c9917a54b889d4a61a4e8322dc5ed9ab73&v=4" alt="Youssef Karoui" />
                ...
                <p>
                Proven track of leadership roles in the customer service feild.
                </p>
            </div>
        </section>
    )
